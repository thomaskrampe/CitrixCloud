<#
 ...
 .LINK
        https://github.com/thomaskrampe/XenAppEssentials/tree/master/ARM-Templates/SimplePoC
...
param (
    ...
    [string]$TemplateFilePath = "https://raw.githubusercontent.com/thomaskrampe/XenAppEssentials/master/ARM-Templates/SimplePoC/azuredeploy.json",  
 
    [string]$ParametersFilePath = "https://raw.githubusercontent.com/thomaskrampe/XenAppEssentials/master/ARM-Templates/SimplePoC/azuredeploy.parameters.json"
)
